              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center mt-4">
                  <Button asChild className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700">
                    <a href="mailto:arizah2020@gmail.com?subject=Project%20inquiry&body=Hi%20Alex%2C%0A%0AProblem%20I%20need%20to%20solve%3A%20%0ACurrent%20system%20or%20site%3A%20%0ADesired%20start%20date%3A%20">Email me</a>
                  </Button>
