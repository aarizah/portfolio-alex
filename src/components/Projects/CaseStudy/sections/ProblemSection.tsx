...
export function ProblemSection({ data }: ProblemSectionProps) {
  return (
    <ProductSection
      ...
      variant="dark"
      align="left"
      className="bg-[radial-gradient(circle_at_50%_18%,rgba(232,180,74,0.10),transparent_34%),#000]"
    ...
    >
      ...
      <Reveal delay={0.12}>
        <div className="mx-auto mt-10 max-w-3xl rounded-[2rem] border border-white/10 bg-white/[0.035] p-5 text-left md:p-7">
          <div className="mb-5 flex items-center gap-3">
            <span className="flex size-10 items-center justify-center rounded-2xl border border-white/10 bg-brand/10">
