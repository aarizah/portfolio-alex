      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {data.blocks.map((block, index) => (
          <Reveal key={block.id} delay={index * 0.08}>
            <article className="relative h-full rounded-3xl border border-white/[0.08] bg-white/[0.04] p-6 text-left transition-all duration-300 hover:-translate-y-1 hover:border-brand/35 hover:bg-white/[0.065]">
