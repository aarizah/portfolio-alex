  ...
  return (
    <section
      ...
      className={cn(
        ...
        variant === "gradient" &&
          "bg-[radial-gradient(circle_at_48%_0%,rgba(232,180,74,0.10),transparent_34%),linear-gradient(180deg,#030303,#080808_48%,#030303)] py-20 md:py-24",
        variant === "spotlight" &&
          "bg-[radial-gradient(circle_at_36%_18%,rgba(232,180,74,0.10),transparent_32%),#050505] py-20 md:py-24",
